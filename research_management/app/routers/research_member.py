...
@router.post("", status_code=status.HTTP_201_CREATED, summary="Thêm thành viên")
...
@router.delete("/{user_id}", status_code=status.HTTP_204_NO_CONTENT, summary="Xóa thành viên")
