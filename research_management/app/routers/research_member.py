...
@router.post("", status_code=status.HTTP_201_CREATED, summary="Thêm thành viên", description="Thêm một người dùng vào đề tài nghiên cứu")
...
@router.delete("/{user_id}", summary="Xóa thành viên", description="Xóa một thành viên khỏi đề tài nghiên cứu")
...
@router.get("", summary="Lấy danh sách thành viên", description="Lấy danh sách thành viên của một đề tài nghiên cứu")
