...
@router.post("", status_code=status.HTTP_201_CREATED, summary="Tạo đề tài nghiên cứu")
...
@router.get("", response_model=list[ProjectResponse], summary="Lấy danh sách đề tài")
...
@router.delete("/{id}", summary="Xóa đề tài")
