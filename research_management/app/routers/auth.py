...
@router.post("/register", status_code=status.HTTP_201_CREATED, summary="Đăng ký", description="Tạo tài khoản người dùng mới")
...
@router.post("/login", summary="Đăng nhập", description="Xác thực người dùng bằng email và mật khẩu")
...
@router.post("/refresh", response_model=TokenResponse, summary="Tạo refresh Token", description="Nhập refresh token để tạo access token mới")
