...
@router.get("/me", response_model=UserResponse, summary="Lấy thông tin người dùng", description="Trả về thông tin của người dùng đang đăng nhập")
def get_me(user = Depends(get_current_user)):
    return user


@router.get("", response_model=list[UserResponse], summary="Lấy danh sách người dùng", description="Lấy danh sách tất cả người dùng")
